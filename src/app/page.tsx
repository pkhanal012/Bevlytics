                ...
                <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                  ...
                  >
                    <span className="relative z-10">
                      a division of parad
                      <span className="text-[#D52383]">Y</span>mdata.com
                    </span>
                    <div className="absolute inset-0 shine-effect"></div>
                  </a>
                </div>
                <h1 className="text-left text-3xl leading-13 sm:text-3xl lg:text-5xl font-medium mb-3 sm:mb-4 text-white">
                  Powered by Semantic AI: <br />
                  Next-Level Insights for <br /> Beverage Data Analytics
                </h1>
                <p className="text-left text-lg sm:text-sm lg:text-base text-opacity-50 text-[#B4B2B3] mb-6 sm:mb-8">
                  <BrandName variant="ai" /> leverages Semantic AI—an advanced
                  technology combining machine learning (ML), natural language
                  processing (NLP), and knowledge graphs—to transform raw
                  distributor and point-of-sale (POS) data into meaningful
                  insights that drive growth and strategic execution.
                </p>
                <div className="flex flex-col  sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                  <a
                    href="/bookdemo"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
              ...
              <div className="lg:col-span-5 lg:sticky lg:top-24 h-fit mb-6 sm:mb-8 lg:mb-32">
                ...
                <p className="text-base sm:text-base lg:text-xl text-gray-400">
                  Whether you manage stock, track sales, or coordinate with
                  distributors — your data should work for you.
                </p>
              </div>
              ...
              <div className="lg:col-span-7 space-y-4 sm:space-y-6 lg:space-y-8 pb-12 sm:pb-16 lg:pb-32">
                ...
                <div className="bg-[#0F0E0E] border border-[#262626]  rounded-xl sm:rounded-2xl lg:rounded-3xl p-4 sm:p-6 lg:p-12">
                  ...
                  <p className="text-base sm:text-base lg:text-xl text-[#9CA3AF] leading-relaxed">
                    Upload messy Excel files - <BrandName /> AI Engine does the
                    cleanup.
                  </p>
                </div>
              </div>
