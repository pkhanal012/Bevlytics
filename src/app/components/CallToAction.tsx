      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center">
          ...
          <h2
            ...
            `}
          >
            Discover how <BrandName variant="ai" className="text-white" />
            &apos;s semantic-driven analytics transform your Beverage&apos;s
            data into actionable insights. Automate scorecards, optimize your
            product strategy, and boost your market performance—all powered by
