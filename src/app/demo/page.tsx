                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-8">
                      <label
                        ...
                        className="block text-white mb-2"
                      >
                        How did you first hear about Data to Insights
                        (D2I&apos;s)
                      </label>
                      <input
                        type="text"
                    ...
                    <button
                      ...
                      className={`w-full ${
                        isSubmitting
                          ? "bg-gray-500"
                          : "bg-[#D52383] hover:bg-[#B01868]"
                      } text-white py-3 px-6 rounded-md font-medium transition-colors flex justify-center items-center`}
                    >
                      {isSubmitting ? (
                        <>
                          <svg
